...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:root@localhost:8889/orders'
...
class Order(db.Model):
    ...
    sellerID = db.Column(db.String(32), nullable=False)
    ...
    def json(self):
        dto = {
            ...
            'status': self.status,
            'sellerID': self.created,
            'dateOfPurchase': self.modified,
            'dateOfModification': self.modified
        }
...
class Order_Item(db.Model):
    ...
    # description = db.Column(db.String(13), nullable=False)
